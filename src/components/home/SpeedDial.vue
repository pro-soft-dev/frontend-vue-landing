...
<template>
  <div
    class="fixed right-4 bottom-7 md:bottom-[50%] flex flex-col-reverse gap-2 md:transform md:translate-y-1/2"
  >
    <!-- Toggle Button -->
    <button
      @click="isOpen = !isOpen"
      :class="[
        'w-12 h-12 bg-orange-600 text-white rounded-full shadow-lg flex items-center justify-center hover:bg-white hover:text-orange-600 transition-colors md:hidden',
      ]"
    >
    ...
    <!-- Action Buttons -->
    <div
      class="flex flex-col-reverse gap-2 transition-all duration-200 origin-bottom mb-2"
      :class="
    ...
    >
      <button
        ...
        :class="
          action.name === 'Post'
            ? 'bg-orange-500 text-white hover:text-orange-white'

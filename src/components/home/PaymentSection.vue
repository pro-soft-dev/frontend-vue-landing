...
const fixedPrice = 54.00
const offerAmount = ref(21)
const minOffer = 21
const maxOffer = 65
const totalFee = computed(() => activeTab.value === 'offer' ? offerAmount.value : fixedPrice)
  ...
  <section class="payment-section bg-white rounded-lg p-6 md:p-10 mb-6">
    ...
    <div class="relative mb-6">
      ...
      <div class="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none">
        <svg v-if="selectedPaymentMethod === 'paypal'" class="w-5 h-5" viewBox="0 0 24 24" fill="#00457C">
          <path
    ...
    <div class="mb-6 hidden md:block">
      ...
      <div class="text-sm text-gray-500">
        <span class="font-bold text-black">+ Fees</span> Approximately EUR {{ paymentFees.toFixed(2) }}
      </div>
    </div>

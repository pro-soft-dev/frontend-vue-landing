...
<template>
  <div class="home pb-24">
    ...
    <main class="max-w-6xl mx-auto px-6 py-8">
      ...
      <div class="mb-16">
        <p class="break-all whitespace-pre-wrap">
          ...
          eget risus at nibh pulvinar tempus in sit amet elit. Nam maximus,
          dolor in aliquam malesuada, odio orci dapibus ipsum, at ullamcorper
          lacus quam ut quam. Donec ultricies sapien libero, a rhoncus magna
          volutpat in. Mauris at dolor vestibulum, commodo erat non, bibendum
          tellus. Nam nec dolor tortor. Curabitur ligula nulla, dignissim ut
          nulla ac, blandit aliquet urna. Vestibulum turpis tortor, placerat
          vulputate libero quis, placerat varius mauris. Ut ac efficitur tellus,
          iaculis rhoncus metus. Aenean condimentum pellentesque neque vitae
          dictum. Donec rhoncus mi orci, eget blandit risus eleifend nec. Duis
          porttitor augue non malesuada pharetra. Nam consequat consequat
          ullamcorper.
          <br />
          <br />
          Fusce commodo vitae neque a aliquet. Duis gravida diam in fringilla
          pharetra. Sed ipsum ex, dapibus eget augue sed, tristique dignissim
          ante. In ornare vulputate elit non auctor. Ut id sagittis est. Duis
          feugiat pulvinar laoreet. Nam ex arcu, pretium vestibulum nunc vel,
          porta viverra lacus. Quisque mauris diam, dignissim gravida velit ac,
          cursus bibendum risus. Nulla dictum tincidunt ligula nec iaculis.
          Vestibulum ullamcorper urna sodales, ullamcorper libero non, laoreet
          felis. Nunc mattis tortor a sem varius pharetra. Proin sodales
          elementum elit eget commodo. Quisque accumsan, sapien elementum
          condimentum elementum, libero turpis tincidunt purus, at iaculis velit
          risus eu sapien. Nam id magna pulvinar, dapibus quam ut, bibendum
          lectus. Vivamus aliquam mi molestie nunc consequat, eu dapibus augue
          gravida
        </p>
        <!-- Map Section -->
      ...
      <section class="analytics mb-12">
        <h3 class="text-xl font-bold mb-6">
          <span class="text-gray-400 text-lg"
            >"Leckerschmecker : Food-Events"</span
          >
          Analytics :
        </h3>
        <div class="gap-3 items-center hidden md:flex">
          <div class="analytics-grid flex flex-col gap-4 w-1/3">
            ...
            <div
              class="stat-card bg-white p-6 rounded-lg shadow flex items-center justify-between text-lg"
            >
        ...
        <div class="md:hidden flex flex-col gap-4 mt-6">
          <div class="analytics-grid flex flex-col gap-3">
            <div
              class="stat-card bg-white p-4 rounded-lg shadow flex items-center justify-between text-lg"
            >
              <div class="text-gray-500">Total Views</div>
              <div class="font-bold">15135</div>
            </div>
        ...
        <div class="mt-12 text-lg">
          ...
          volutpat in. Mauris at dolor vestibulum, commodo erat non, bibendum
          tellus. Nam nec dolor tortor. Curabitur ligula nulla, dignissim ut
          nulla ac, blandit aliquet urnies.
        </div>
      </section>
      ...
      <div class="mt-12 space-y-6">
        ...
        <!-- Author Section -->
        <div
          class="flex items-center gap-4 mt-8 mb-12 border-b border-gray-300 pb-12"
        >
          <div
          ...
          <div>
            <div class="text-orange-500 font-medium flex items-center gap-3">
              <div>Ellen EdwardoEllen Edwardo</div>
              <svg
                class="w-5 h-5"
                fill="none"
                stroke="currentColor"
        ...
        <div class="mt-8">
          ...
          <div class="space-y-2">
            <div
              class="flex items-center justify-between py-5 hover:bg-gray-50 p-2 rounded cursor-pointer"
            >
    ...
    <MapPopup
      :show="showMap"
      @close="showMap = false"
      v-bind:class="{ 'modal-enter-active': showMap }"
    />
    <CreateAuctionPopup
      :show="showCreateAuction"
      @close="showCreateAuction = false"

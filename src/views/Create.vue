    ...
    <form class="space-y-6" @submit="submitForm">
      ...
      <div>
        ...
        <input
          ...
          v-model="category"
          name="category"
          placeholder="Type at least 4 first few it words"
          class="w-full px-3 border border-gray-300 focus:outline-orange-500 focus:placeholder-orange-500 p-4"
        />
      </div>
        ...
        <div class="flex flex-wrap gap-2">
          <button
            ...
            :class="[
              ...
              tag.value === category.toLowerCase()
                ? 'bg-orange-500 text-white'
                : '',
            ]"
            @click="
              category = tag.value.charAt(0).toUpperCase() + tag.value.slice(1)
            "
          >
            {{ tag.label }}
          </button>
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-4"
          >Money Year Bid</label
        >
        <div class="text-sm text-gray-600 mb-4">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur
          eget risus at nibh pulvinar tempus in sit amet elit
        </div>
      ...
      <!-- Payment Method -->
      <div>
        <label class="block text-sm font-medium text-gray-700 my-6 mt-10"
        ...
        <div class="flex flex-wrap gap-4">
          <button
            ...
            :class="[
              'flex flex-col items-center justify-center gap-1 p-4 border hover:bg-gray-50 w-30',
          ...
          <button
            ...
            :class="[
              'flex items-center flex-col justify-center gap-1 p-4 border hover:bg-gray-50 w-30',
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-2"
          >Why are you making this article?</label
        >
        <div class="space-y-2">
      ...
      <div class="space-y-3">
        <button
          type="submit"
          class="w-full py-3 text-white rounded-lg bg-orange-600"
        >
          Publish
        </button>
        <button
          type="button"
          class="w-full py-3 border-orange-500 border text-orange-500 rounded-lg hover:bg-gray-50"
        >
          Preview
        </button>
        <button
          type="button"
          class="w-full py-3 border border-black text-black rounded-lg hover:bg-gray-50"
        >
          Save & Post it Later
        </button>
        <button
